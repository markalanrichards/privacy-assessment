...
public class AvroTest {
    ...
    public void setup() throws IOException {
        this.customerProfileAvpr = createClient(CustomerProfileAvpr.PROTOCOL, CustomerProfileAvpr.class);
    ...
    private <T> T createClient(Protocol protocol, Class<T> iface) throws IOException {
        final URI url = webInstance.webClient()
                .getUrlHelper()
                .toBuilder()
                .path(Optional.of(String.format("/avpr/%s.%s", protocol.getNamespace(), protocol.getName())))
                .build()
                .getUrl();
    ...
    @Test
    public void testCustomerProfileClient() throws AvroRemoteException {
        final CustomerProfileAvro customerProfileAvro = createCustomerProfile("testEmail", "testExternalLegalName");
        Assert.assertThat(customerProfileAvro, IsEqual.equalTo(customerProfileAvpr.avroReadCustomerProfile(customerProfileAvro.getId())));
        final CustomerProfileAvro customerProfileAvro1 = customerProfileAvpr.avroUpdateCustomerProfile(CustomerProfileUpdateAvro.newBuilder()
                ...
                .build());
        Assert.assertThat(customerProfileAvro1, IsEqual.equalTo(customerProfileAvpr.avroReadCustomerProfile(customerProfileAvro.getId())));
        final CustomerProfileAvro customerProfileAvro2 = customerProfileAvpr.avroReadVersionedCustomerProfile("1", "1");
        Assert.assertThat(customerProfileAvro1, IsEqual.equalTo(customerProfileAvro2));
    }

    private CustomerProfileAvro createCustomerProfile(String testEmail, String testExternalLegalName) throws AvroRemoteException {
        final CustomerProfileCreateAvro customerProfileCreateAvro = CustomerProfileCreateAvro.newBuilder()
    ...
    @Test
    public void testSubjectProfileClient() throws AvroRemoteException {

        final SubjectProfileAvro subjectProfileAvro = createSubjectProfile();
        Assert.assertThat(subjectProfileAvro, IsEqual.equalTo(subjectProfileAvpr.avroReadSubjectProfile(subjectProfileAvro.getId())));
        final SubjectProfileAvro subjectProfileAvro1 = subjectProfileAvpr.avroUpdateSubjectProfile(SubjectProfileUpdateAvro.newBuilder()
                ...
                .build());
        Assert.assertThat(subjectProfileAvro1, IsEqual.equalTo(subjectProfileAvpr.avroReadSubjectProfile(subjectProfileAvro.getId())));
        final SubjectProfileAvro subjectProfileAvro2 = subjectProfileAvpr.avroReadVersionedSubjectProfile("1", "1");
        Assert.assertThat(subjectProfileAvro1, IsEqual.equalTo(subjectProfileAvro2));
        List<SubjectProfileAvro> subjectProfileAvros = subjectProfileAvpr.avroReadSubjectProfilesForCustomerProfile(subjectProfileAvro.getCustomerProfileId());
        Assert.assertThat(Lists.immutable.ofAll(subjectProfileAvros), IsEqual.equalTo(Lists.immutable.of(subjectProfileAvro2)));
    }

    private SubjectProfileAvro createSubjectProfile() throws AvroRemoteException {
        final CustomerProfileAvro customerProfile = createCustomerProfile("testSubjectEmail", "testSubjectExternalLegalName");
        final SubjectProfileCreateAvro customerProfileCreateAvro = SubjectProfileCreateAvro.newBuilder()
                .setExternalSubjectReference("testSubjectReference")
    ...
    private PIACreateAvro createPIA() throws AvroRemoteException {
    ...
    @Test
    public void testPIAClient() throws AvroRemoteException {
        ...
        final PIAAvro updatePiaAvro = piaAvpr.avroUpdatePIA(PIAUpdateAvro.newBuilder()
                .setId(piaAvro.getId())
                .setLastVersion(piaAvro.getVersion())
                .setSubjectProfileId(piaCreateAvro.getSubjectProfileId())
                .setDocument(PIADocumentAvro.newBuilder()
                        .setAnnex1(document.getAnnex1())
                        .setAnnex2(document.getAnnex2())
                        .setAnnex3(PIAAnnex3Avro.newBuilder(document.getAnnex3())
                                .setPrinciple1(PIAAnnex3Principle1Avro.newBuilder(document.getAnnex3().getPrinciple1())
                                        .setQuestion1("a_different_question").build())
                                .build())
                        .build())
                .build());
    ...
    @Test
    public void testPrivacyImpactAssessmentAnnexOneClient() throws AvroRemoteException {
        final SubjectProfileAvro subjectProfileAvro = createSubjectProfile();
        ImmutableMap<String, String> iniitalQuesions = Maps.immutable.of("testQuestion1", "testAnswer1");
        Map<String, String> value = iniitalQuesions.toMap();
        final PIACreateAvro create = PIACreateAvro.newBuilder()
                .setSubjectProfileId(subjectProfileAvro.getId())
                .setDocument(createTestDocument())
                .build();
        PIAAvro firstRest = privacyImpactAssessmentAnnexOneAvpr.avroCreatePIA(create);
        Assert.assertThat(firstRest, IsEqual.equalTo(privacyImpactAssessmentAnnexOneAvpr.avroReadPIA(firstRest.getId())));
        final PIADocumentAvro testDocument = createTestDocument();
        PIAUpdateAvro build = PIAUpdateAvro.newBuilder()
                .setId(firstRest.getId())
                .setLastVersion(firstRest.getVersion())
                .setDocument(PIADocumentAvro.newBuilder(testDocument).setAnnex1(PIAAnnex1Avro.newBuilder(testDocument.getAnnex1()).setQuestion1("SomethingElse").build()).build())
        ...
        Assert.assertThat(updated, IsEqual.equalTo(privacyImpactAssessmentAnnexOneAvpr.avroReadPIA(firstRest.getId())));
        final PIAAvro privacyImpactAssessmentAnnexOneAvro = privacyImpactAssessmentAnnexOneAvpr.avroReadVersionedPIA("1", "1");
