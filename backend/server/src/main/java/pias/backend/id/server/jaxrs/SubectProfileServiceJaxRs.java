...
public class SubectProfileServiceJaxRs implements SubjectProfileServiceInterfaceJaxRs {
    ...
    public SubjectProfileJaxRs create(SubjectProfileCreateJaxRs customerProfileCreateJaxRs) {
        ...
        SubjectProfile customerProfile = mysqlSubjectProfileService.createSubjectProfile(customerProfileCreate);
    ...
    public SubjectProfileJaxRs update(SubjectProfileUpdateJaxRs customerProfileUpdateJaxRs) {
        ...
        SubjectProfile customerProfile = mysqlSubjectProfileService.updateSubjectProfile(customerProfileUpdate);
        return SubjectProfileJaxRs.toJaxRs(customerProfile);
    }

    @Override
    public SubjectProfileJaxRs read(String id) {
        SubjectProfile customerProfile = mysqlSubjectProfileService.readSubjectProfile(Long.valueOf(id));
        return SubjectProfileJaxRs.toJaxRs(customerProfile);
    }

    @Override
    public SubjectProfileJaxRs read(String id, String version) {
        SubjectProfile customerProfile = mysqlSubjectProfileService.readSubjectProfile(Long.valueOf(id), Long.valueOf(version));
        return SubjectProfileJaxRs.toJaxRs(customerProfile);
    }
