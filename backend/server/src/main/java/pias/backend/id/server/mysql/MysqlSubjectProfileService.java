...
public class MysqlSubjectProfileService implements SubjectProfileService {
  private static final Logger LOGGER = LogManager.getLogger(MysqlSubjectProfileService.class);
  ...
  public static final String INSERT_NEW_CUSTOMER_PROFILE_ID =
      String.format(
          ...
          TABLE_SUBJECT_PROFILE_IDS, FIELD_ID, FIELD_VERSION, FIELD_ID, FIELD_VERSION);
    ...
    return handle
        ...
        .map(
            (i, resultSet, statementContext) -> {
              ...
              final String exernalSubjectReference = resultSet.getString(FIELD_SUBJECT_REFERENCE);
