...
public class CreateSubjectProfile {
    ...
    @Parameter(names = {"-customer-id", "-c"}, description = "Customer id", required = true)
    private String customerProfileId;
    @Parameter(names = {"-name", "-n"}, description = "Subject Name", required = true)
    private String externalSubjectName;

    @Parameter(names = {"-reference", "-r"}, description = "Subject Reference", required = true)
