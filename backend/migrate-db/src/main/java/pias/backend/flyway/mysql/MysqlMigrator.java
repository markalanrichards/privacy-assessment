...
public class MysqlMigrator implements Function<MigrationConfig, FlywayConfig>, Consumer<MigrationConfig> {
    final Migrator migration = new Migrator((migrationConfig) -> new MysqlFlywayManaged(apply(migrationConfig)));
